    ...
    <div className="bg-background">
      ...
      <section className="relative py-20 md:py-32 text-white">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <h1 className="text-4xl md:text-5xl font-bold">Civil Engineering Services</h1>
          <p className="mt-4 text-lg text-primary-foreground/90 max-w-3xl mx-auto">
            Building the Future with Precision, Quality, and Durability. Service based on Due Diligence.
          </p>
        </div>
      </section>
